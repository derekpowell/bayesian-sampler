...
t2_df %>% 
  ...
  kbl(
    ...
    digits=3, 
    booktabs=T,
    col.names = c("Model", "$\\widehat{\\text{elpd}}_{\\text{LOO}}$", "Penalty","$r_{resp}$", "$r_{query}$", "$\\widehat{\\text{elpd}}_{\\text{LOO}}$", "Penalty","$r_{resp}$", "$r_{query}$"),
    escape = F
    ) %>%

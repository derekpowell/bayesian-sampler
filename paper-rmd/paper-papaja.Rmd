...
t2_df %>% 
  ...
  kbl(
    ...
    digits=3, 
    booktabs=T,
    col.names = c("Model", "$LOO_{ic}$", "Penalty","$r_{resp}$", "$r_{query}$", "$LOO_{ic}$", "Penalty","$r_{resp}$", "$r_{query}$"),
    escape = F
    ) %>%

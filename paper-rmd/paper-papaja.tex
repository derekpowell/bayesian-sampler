...
Correspondence concerning this article should be addressed to Derek Powell, 4701 W Thunderbird Rd, Phoenix AZ 85306. E-mail: \href{mailto:dmpowell@asu.edu}{\nolinkurl{dmpowell@asu.edu}}
...
\subsubsection{Conflict of Interests}\label{conflict-of-interests}}
...
This paper presents secondary analyses of data. The datasets generated and/or analysed during the current study are available at \url{https://osf.io/mgcxj/files/}.

\hypertarget{code-availability}{%
\subsubsection{Code availability}\label{code-availability}}

All analysis code is available at \url{https://github.com/derekpowell/bayesian-sampler} and at \url{https://osf.io/bpkjf/}.
...
\hypertarget{consent-to-publish}{%
\subsubsection{Consent to publish}\label{consent-to-publish}}
